          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/forgotpassword" className="text-md font-medium text-blue-600 hover:underline dark:text-blue-500">Forgot password?</a>
              </div>
              ...
              <div>
                <p className="text-md font-light text-gray-500 dark:text-gray-400">
                  Don’t have an account yet? <Link href="/register" className="font-semibold mytxt hover:underline dark:text-blue-500">Register</Link>
                </p>
                <p className="text-md font-light text-gray-500 dark:text-gray-400">
